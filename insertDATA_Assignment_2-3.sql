...
VALUES					('lms1.vti.edu.vn@gmail.com',	'username1',	'fullname1',			1,				1),
						...
						('lms4.vti.edu.vn@gmail.com',	'username4',	'fullname4',			2,				4),
...
VALUES				('Hỏi đáp Java',			7,					1,					5),
					('Hỏi đáp .NET',			4,					2,					8),
					('Hỏi đáp SQL',				10,					2,					4),
					('Hỏi đáp Postman',			6,					2,					3),
					('Hỏi đáp Ruby',			8,					1,					2),
                    ('Hỏi đáp ASP.NET',			5,					2,					2),
                    ('Hỏi đáp C++',				3,					2,					4),
                    ('Hỏi đáp NodeJS',			2,					1,					6),
                    ('Hỏi đáp ReactJS',			9,					1,					8),
                    ('Hỏi đáp PHP',				1,					1,					9);
