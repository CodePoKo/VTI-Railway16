...
//			fullname += word + " ";
//		}
		// \\d+ : là chuỗi các số liền nhau
		// \\s+ : là chuỗi các dấu cách liền nhau
//    	System.out.println("Chuẩn hóa: " + fullname.replaceAll("\\d+", ""));
    	...
    	// Scanner scan1 = new Scanner(System.in);
     	...
     	// String chuoi1 = scan1.nextLine();
     	// System.out.println("Nhập chuỗi 2: ");
     	// String chuoi2 = scan1.nextLine();
     	// String reversechuoi = "";
     	// for (int i = chuoi1.length() - 1; i >= 0; i--) {
     	// 	reversechuoi += chuoi1.substring(i , i + 1);
		// }
     	
     	// if(chuoi2.equals(reversechuoi)) {
...
//		}
    ...
    public static void Exersise5() {
        ...
        //Question6:
    	System.out.println("\tQuestion6");
    	String[] departments = new String[] {"Boss of director ", "Marketing",
    			"Sale", "Waiting room", "Accounting"};
		...
		//Question7:
    	System.out.println("\tQuestion7");
    	String[] departments2 = new String[] {"Boss of director ", "Marketing",
    			"Sale", "Waiting room", "Accounting"};
				
		Arrays.sort(departments2);
